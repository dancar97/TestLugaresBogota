...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mServiceFeatureTable = new ServiceFeatureTable("https://services.arcgis.com/8DAUcrpQcpyLMznu/ArcGIS/rest/services/Mapa_de_ensayaderos_Bogot%C3%A1_WFL1/FeatureServer/0");
